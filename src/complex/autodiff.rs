...
{
    type ReType =
        AutoDiff<StaticArgsType, InputType, OutputType, GradType, ADRe<A, InputF, OutputF, GradF>>;
    type ImType =
        AutoDiff<StaticArgsType, InputType, OutputType, GradType, ADIm<A, InputF, OutputF, GradF>>;
    type NormSqrType = AutoDiff<
        StaticArgsType,
        InputType,
        OutputType,
        GradType,
        ADNormSqr<A, InputF, OutputF, GradF>,
    >;
    type NormType = AutoDiff<
        StaticArgsType,
        InputType,
        OutputType,
        GradType,
        ADNorm<A, InputF, OutputF, GradF>,
    >;
    type ArgType =
        AutoDiff<StaticArgsType, InputType, OutputType, GradType, ADArg<A, InputF, OutputF, GradF>>;
