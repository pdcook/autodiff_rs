...
impl_dim_sub!(Ix0, Ix1, Ix0);
impl_dim_sub!(Ix0, Ix2, Ix0);
impl_dim_sub!(Ix0, Ix3, Ix0);
impl_dim_sub!(Ix0, Ix4, Ix0);
impl_dim_sub!(Ix0, Ix5, Ix0);
impl_dim_sub!(Ix0, Ix6, Ix0);
impl_dim_sub!(Ix1, Ix0, Ix1);
impl_dim_sub!(Ix1, Ix1, Ix0);
impl_dim_sub!(Ix1, Ix2, Ix0);
impl_dim_sub!(Ix1, Ix3, Ix0);
impl_dim_sub!(Ix1, Ix4, Ix0);
impl_dim_sub!(Ix1, Ix5, Ix0);
impl_dim_sub!(Ix1, Ix6, Ix0);
impl_dim_sub!(Ix2, Ix0, Ix2);
impl_dim_sub!(Ix2, Ix1, Ix1);
impl_dim_sub!(Ix2, Ix2, Ix0);
impl_dim_sub!(Ix2, Ix3, Ix0);
impl_dim_sub!(Ix2, Ix4, Ix0);
impl_dim_sub!(Ix2, Ix5, Ix0);
impl_dim_sub!(Ix2, Ix6, Ix0);
impl_dim_sub!(Ix3, Ix0, Ix3);
impl_dim_sub!(Ix3, Ix1, Ix2);
impl_dim_sub!(Ix3, Ix2, Ix1);
impl_dim_sub!(Ix3, Ix3, Ix0);
impl_dim_sub!(Ix3, Ix4, Ix0);
impl_dim_sub!(Ix3, Ix5, Ix0);
impl_dim_sub!(Ix3, Ix6, Ix0);
impl_dim_sub!(Ix4, Ix0, Ix4);
impl_dim_sub!(Ix4, Ix1, Ix3);
impl_dim_sub!(Ix4, Ix2, Ix2);
impl_dim_sub!(Ix4, Ix3, Ix1);
impl_dim_sub!(Ix4, Ix4, Ix0);
impl_dim_sub!(Ix4, Ix5, Ix0);
impl_dim_sub!(Ix4, Ix6, Ix0);
